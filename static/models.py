...
class Profile(models.Model):
    ...
    created_at = models.DateTimeField(name="profile_created", auto_now_add=True)
    ends_at = models.DateTimeField(name="profile_ends", auto_now=True)
...
class Account(models.Model):
    ...
    started_at = models.DateTimeField(name="account_started", auto_now_add=True)
    ended_at = models.DateTimeField(name="account_ended", auto_now=True)
    refil_count = models.IntegerField(name="account_refil_count", default=0)
    refil_date = models.DateTimeField(name="account_refil_date", auto_now=True)
